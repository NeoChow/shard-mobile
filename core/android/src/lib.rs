...
extern crate jni;
use self::jni::JNIEnv;
use self::jni::objects::{JString, JObject, JValue, GlobalRef};
...
pub unsafe extern fn Java_app_visly_vml_ViewManager_bind(env: JNIEnv<'static>, j_view_manager: JObject) -> jlong {
    Box::into_raw(JavaObject::new(env, j_view_manager)) as jlong
}

#[no_mangle]
pub extern fn Java_app_visly_vml_ViewManager_render(
    env: JNIEnv<'static>,
    _: JObject,
    view_manager: jlong,
    json: JString
...
#[no_mangle]
#[allow(non_snake_case)]
pub unsafe extern fn Java_app_visly_vml_View_bind(env: JNIEnv<'static>, j_view: JObject) -> jlong {
