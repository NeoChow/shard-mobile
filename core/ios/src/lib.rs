...
#[no_mangle]
pub extern fn vml_view_free(view: *mut IOSView) {
    unsafe { Box::from_raw(view); }
}

#[no_mangle]
pub extern fn vml_view_manager_new(
    context: *const c_void, 
    create_view: fn(*const c_void, *const c_char) -> *mut IOSView
...
#[no_mangle]
pub extern fn vml_view_manager_free(view_manager: *mut IOSViewManager) {
    unsafe { Box::from_raw(view_manager); }
}

#[no_mangle]
pub extern fn vml_render(
